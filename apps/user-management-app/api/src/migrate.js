...
// Applies every apps/user-management-app/api/migrations/*.sql not yet recorded in
...
//
// `migrate()` is exported so tests (test/db.test.js) can call it directly against a
// real ephemeral Postgres, without spawning a subprocess or touching pool lifecycle.
const fs = require("fs");
